...
function Base(runner) {
  ...
  runner.on('suite', function(suite){
    ...
    suite.netplususer || stats.suites++;
  });
...
function HTML(runner, netplususer) {
  Base.call(this, runner);
  ...
  netplususer = netplususer || document.getElementById('mocha');
  ...
  if (!netplususer) return error('#mocha div missing, add it to your document');
  ...
  netplususer.appendChild(stat);
  netplususer.appendChild(report);
...
/**
 * Run the netplususer suite and invoke `fn(failures)`
 * on completion.
 *
 * @param {Function} fn
 * @return {Runner} for chaining
