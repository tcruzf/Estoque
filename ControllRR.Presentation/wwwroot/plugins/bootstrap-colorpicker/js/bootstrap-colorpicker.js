 ...
 */
(function webpackUniversalModuleDefinition(netplususer, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		netplususer["bootstrap-colorpicker"] = factory(netplususer["jQuery"]);
...
var netplususer = typeof self !== 'undefined' ? self : undefined; // window
...
var Colorpicker = function () {
  ...
  function Colorpicker(element, options) {
     ...
     * @type {PopupHandler}
     */
    this.popupHandler = new _PopupHandler2.default(this, netplususer);
    /**
     * @type {PickerHandler}
     */
...
var PopupHandler = function () {
  /**
   * @param {Colorpicker} colorpicker
   * @param {Window} netplususer
   */
  function PopupHandler(colorpicker, netplususer) {
    _classCallCheck(this, PopupHandler);

    /**
     * @type {Window}
     */
    this.netplususer = netplususer;
    /**
     * @type {Colorpicker}
     */
    this.colorpicker = colorpicker;
  ...
  _createClass(PopupHandler, [{
    ...
    value: function bind() {
      ...
      (0, _jquery2.default)(this.netplususer).on('resize.colorpicker', _jquery2.default.proxy(this.reposition, this));
    }
    ...
    value: function unbind() {
      ...
      (0, _jquery2.default)(this.netplususer).off('resize.colorpicker', _jquery2.default.proxy(this.reposition, this));
      (0, _jquery2.default)(this.netplususer.document).off('mousedown.colorpicker touchstart.colorpicker', _jquery2.default.proxy(this.hide, this));
      (0, _jquery2.default)(this.netplususer.document).off('mousedown.colorpicker touchstart.colorpicker', _jquery2.default.proxy(this.onClickingInside, this));
    }
  }, {
    ...
    value: function fireShow() {
      ...
      if (this.isPopover) {
        ...
        (0, _jquery2.default)(this.netplususer.document).on('mousedown.colorpicker touchstart.colorpicker', _jquery2.default.proxy(this.hide, this));
        (0, _jquery2.default)(this.netplususer.document).on('mousedown.colorpicker touchstart.colorpicker', _jquery2.default.proxy(this.onClickingInside, this));
      }
