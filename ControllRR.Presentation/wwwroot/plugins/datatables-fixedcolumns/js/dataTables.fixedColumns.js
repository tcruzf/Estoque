...
$.extend( FixedColumns.prototype , {
	...
	"_fnEqualiseHeights": function ( nodeName, original, clone )
	{
		...
		var that = this,
			...
			netplususerOriginal = original.getElementsByTagName(nodeName)[0],
			netplususerClone    = clone.getElementsByTagName(nodeName)[0],
			jqBoxHack    = $('>'+nodeName+'>tr:eq(0)', original).children(':first'),
			iBoxHack     = jqBoxHack.outerHeight() - jqBoxHack.height(),
			anOriginal   = this._fnGetTrNodes( netplususerOriginal ),
			anClone      = this._fnGetTrNodes( netplususerClone ),
			heights      = [];
