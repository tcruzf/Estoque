...
{
    /// <inheritdoc />
    public partial class ChangedStockNews : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalTaxes = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    NFeAccessKey = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    NFeEmissionDate = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    StockId = table.Column<int>(type: "int", nullable: false),
                    NFeSource = table.Column<int>(type: "int", nullable: true),
                    NFeStatus = table.Column<int>(type: "int", nullable: true),
                    IssuerCNPJ = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IssuerIE = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FreightMode = table.Column<int>(type: "int", nullable: true),
                    PaymentMethod = table.Column<int>(type: "int", nullable: true),
                    ReferenceNFeKey = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductApplication = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ProductReference = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PurchasePrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 0m),
                    SalePrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    SupplierId = table.Column<int>(type: "int", nullable: true),
                    TaxRate = table.Column<decimal>(type: "decimal(5,2)", nullable: false, defaultValue: 0m),
                    Profit = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    PriceSugested = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    ProductInternalCode = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ProductBarCode = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CFOPId = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IcmsBase = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    IcmsAmount = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    PisBase = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    PisAmount = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    CofinsBase = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    CofinsAmount = table.Column<decimal>(type: "decimal(65,30)", nullable: true)
                },
                constraints: table =>
                {
